...
export const categorias = [
  ...
  },
  {
    ...
    tipo: "misc",
    itens: [
      { nome: "Mandra (Pílula)", cost: "500 PO", weight_in_load: 0, img: `${IC}/magic-potion.svg`, desc: "<p>Cura 4d6+3 PV e funciona como antídoto. <strong>Vício 1–2.</strong> Colateral/abstinência: insônia e exaustão permanente. <em>Narcoguerreiro fabrica por 250 PO em 2 semanas (JP Difícil −5).</em></p>" },
      ...
      { nome: "Albinus", cost: "500 PO", weight_in_load: 0, img: `${IC}/magic-potion.svg`, desc: "<p>Cura total (exceto dano de fogo e ácido). <strong>Vício 1.</strong> Colateral: perda de 1d4 PV máximos por semana. Extraído ritualmente de Trolls das fendas térmicas de Vornfell. <em>Narcoguerreiro fabrica por 250 PO em 2 semanas (JP Difícil −5).</em></p>" },
      { nome: "Fungo Sangue", cost: "100 PO", weight_in_load: 0, img: `${IC}/magic-potion.svg`, desc: "<p>Concede Força 18 por 1d4 + Nível rodadas. <strong>Vício 1.</strong> Colateral: perda de 1d4 PV. <em>Cogumelo de Combate: Narcoguerreiro fabrica por 50 PO em 1 semana.</em></p>" },
      { nome: "Fungo Escarlate", cost: "100 PO", weight_in_load: 0, img: `${IC}/magic-potion.svg`, desc: "<p>Concede Destreza 18 por 1d4 + Nível rodadas. <strong>Vício 1.</strong> Colateral: exaustão por 1 turno. <em>Cogumelo de Combate: Narcoguerreiro fabrica por 50 PO em 1 semana.</em></p>" },
      { nome: "Fungo Azure", cost: "100 PO", weight_in_load: 0, img: `${IC}/magic-potion.svg`, desc: "<p>Concede Sabedoria 18 e Visão no Escuro. <strong>Vício 1.</strong> Colateral: cegueira temporária. <em>Cogumelo de Combate: Narcoguerreiro fabrica por 50 PO em 1 semana.</em></p>" },
      { nome: "Fungo Ébano", cost: "100 PO", weight_in_load: 0, img: `${IC}/magic-potion.svg`, desc: "<p>Concede Pele de Pedra (+4 na CA). <strong>Vício 1.</strong> Colateral: testes Difíceis por 1d4 dias. <em>Cogumelo de Combate: Narcoguerreiro fabrica por 50 PO em 1 semana.</em></p>" },

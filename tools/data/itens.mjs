...
export const categorias = [
  ...
  },
  {
    ...
    itens: [
      ...
      { nome: "Bala de Chumbo (20)", cost: "4 PO", weight_in_load: 0, img: "icons/consumables/ammunition/3-bullets-lead-grey.webp", desc: "<p>Munição comum para armas de fogo (pacote com 20). Variantes especiais e de cristal nas categorias Munições.</p>" },
    ],
  },
  {
    ...
    tipo: "misc",
    itens: [
      { nome: "Prata", cost: "", weight_in_load: 0, img: "icons/commodities/metal/ingot-stamped-silver.webp", desc: "<p>Essencial contra licantropos e certas categorias de mortos-vivos. Amplamente disponível em centros urbanos. <strong>Custo: ×2 o valor base</strong> da arma/armadura forjada nele.</p>" },
      { nome: "Bronze", cost: "", weight_in_load: 0, img: "icons/commodities/metal/ingot-stamped-bronze.webp", desc: "<p>Em armaduras: −1 na CA, mas diminui o peso (armadura pesada de bronze conta como média para Carga). Em armas de fogo: reduz a Carga da arma em 1 (mínimo 1). <strong>Custo: ×1,5 o valor base.</strong></p>" },
      { nome: "Mitral", cost: "", weight_in_load: 0, img: "icons/commodities/metal/ingot-stamped-steel.webp", desc: "<p>Torna armaduras mais leves (+1 na CA) e armas mais afiadas (+1 no dano). Em armas de fogo: +1 no dano e só engasga em 1 natural se também falhar no ataque. Extremamente raro. <strong>Custo: ×10 o valor base.</strong></p>" },
      { nome: "Arkanita", cost: "", weight_in_load: 0, img: "icons/commodities/gems/gem-faceted-octagon-teal.webp", desc: "<p>Mineral que sustenta Arkádia, sagrado para os Clãs Mantis. Em armaduras: +1 em todas as JP contra magias. Em armas: o dano é mágico, afetando criaturas imunes a armas normais. <strong>Custo: ×5 o valor base.</strong></p>" },
      { nome: "Ônix", cost: "", weight_in_load: 0, img: "icons/commodities/gems/gem-faceted-octagon-black.webp", desc: "<p>Extraído das Montanhas de Ônix Negro de Breônia. Em armaduras: teste Fácil em Furtividade. Em armas brancas: +2 no dano em Ataques Furtivos ou pelas costas. Em armas de fogo: disparo completamente silencioso. <strong>Custo: ×4 o valor base.</strong></p>" },
      { nome: "Centelha Solar", cost: "", weight_in_load: 0, img: "icons/commodities/gems/gem-faceted-radiant-orange.webp", desc: "<p>Forjado pela Guilda dos Ferreiros de Benellikov. Em armaduras: +1 em todas as JP contra medo, paralisia ou necromancia. Em armas: no primeiro ataque bem-sucedido de cada combate, +1d6 de dano de fogo. <strong>Custo: ×6 o valor base.</strong></p>" },
      { nome: "Erebo", cost: "", weight_in_load: 0, img: "icons/commodities/gems/gem-faceted-octagon-purple.webp", desc: "<p>Cristal raro que consome magia. Em armaduras: ao passar na JP contra uma magia, o efeito é totalmente anulado (sem dano parcial). Em armas: o alvo atingido tem a próxima magia que conjurar absorvida. Em armas mágicas: reduz o bônus em −1 por dia até ser removido. <strong>Custo: ×7 o valor base.</strong></p>" },
    ],
  },
  {
    ...
    tipo: "misc",
    itens: [
      { nome: "Balas de Prata (10)", cost: "50 PO", weight_in_load: 0, img: "icons/consumables/ammunition/3-bullets-cream-grey.webp", desc: "<p>Pacote com 10. Causa dano completo em criaturas vulneráveis à Prata (licantropos, certos mortos-vivos).</p>" },
      { nome: "Balas de Ferro Frio (10)", cost: "75 PO", weight_in_load: 0, img: "icons/consumables/ammunition/3-bullets-blue-grey.webp", desc: "<p>Pacote com 10. Causa dano completo em criaturas vulneráveis ao Ferro Frio — fadas, demônios menores.</p>" },
      { nome: "Balas Perfurantes (Mitral) (10)", cost: "150 PO", weight_in_load: 0, img: "icons/consumables/ammunition/3-bullets-paper-gold.webp", desc: "<p>Pacote com 10. Ignora 2 pontos de CA do alvo.</p>" },
    ],
  },
  {
    ...
    tipo: "misc",
    itens: [
      { nome: "Flecha de Arcanita", cost: "50 PO", weight_in_load: 0, img: "icons/weapons/ammunition/arrow-head-war-flight.webp", desc: "<p>Ataque Muito Fácil (+5). <strong>Risco:</strong> 1d6 de dano mágico ao usuário e a arma é danificada.</p>" },
      { nome: "Virote de Arcanita", cost: "60 PO", weight_in_load: 0, img: "icons/weapons/ammunition/bolt-feathered-glowing-white.webp", desc: "<p>Ataque Muito Fácil (+5) contra alvos de metal. <strong>Efeito:</strong> em crítico de 20, o alvo faz JPS ou sofre Silêncio por 1d4 rodadas.</p>" },
      { nome: "Bala de Arcanita", cost: "100 PO", weight_in_load: 0, img: "icons/weapons/ammunition/bullet-cream.webp", desc: "<p>+2d6 de dano mágico; o alvo faz JPC ou fica Atordoado. <strong>Risco:</strong> a munição explode, causando 2d6 ao usuário e destruindo a arma.</p>" },
      { nome: "Flecha de Ônix", cost: "40 PO", weight_in_load: 0, img: "icons/weapons/ammunition/arrow-head-war-flight.webp", desc: "<p>Ataque Fácil (+2) nas sombras. +1d4 de dano mágico; realiza crítico com 19–20.</p>" },
      { nome: "Virote de Ônix", cost: "50 PO", weight_in_load: 0, img: "icons/weapons/ammunition/bolt-feathered-glowing-white.webp", desc: "<p>+1d6 de dano mágico; cura 1d4 PV do atirador. <strong>Contra mortos-vivos:</strong> causa Exaustão.</p>" },
      { nome: "Bala de Ônix", cost: "80 PO", weight_in_load: 0, img: "icons/weapons/ammunition/bullet-cream.webp", desc: "<p><strong>Efeito:</strong> −1 de Força no alvo por 8 turnos e cria Escuridão num raio de 4,5 m.</p>" },
      { nome: "Flecha de Centelha Solar", cost: "70 PO", weight_in_load: 0, img: "icons/weapons/ammunition/arrow-head-war-flight-orange.webp", desc: "<p>+1d4 de dano de fogo; provoca Ignição no alvo.</p>" },
      { nome: "Virote de Centelha Solar", cost: "85 PO", weight_in_load: 0, img: "icons/weapons/ammunition/bolt-feathered-glowing-orange.webp", desc: "<p>+1d6 de dano de fogo; provoca Cegueira. <strong>Risco:</strong> JPC se usado sob sol forte.</p>" },
      { nome: "Bala de Centelha Solar", cost: "150 PO", weight_in_load: 0, img: "icons/weapons/ammunition/bullet-orange.webp", desc: "<p>Dano em Área: 3d6 de fogo em raio de 3 m. <strong>Risco:</strong> pode explodir no inventário.</p>" },
      { nome: "Flecha de Erebo", cost: "40 PO", weight_in_load: 0, img: "icons/weapons/ammunition/arrow-head-war-flight-purple.webp", desc: "<p>Ataque Fácil (+2) nas sombras. <strong>Efeito:</strong> apaga luzes menores no ponto de impacto por 1d4 rodadas.</p>" },
      { nome: "Virote de Erebo", cost: "50 PO", weight_in_load: 0, img: "icons/weapons/ammunition/bolt-feathered-glowing-purple.webp", desc: "<p><strong>Efeito:</strong> o alvo faz conjurações com ajuste Difícil (−2) por 1d4 rodadas.</p>" },
      { nome: "Bala de Erebo", cost: "100 PO", weight_in_load: 0, img: "icons/weapons/ammunition/bullet-purple.webp", desc: "<p><strong>Efeito:</strong> todos os itens mágicos do alvo tornam-se mundanos por 1d4 rodadas.</p>" },
    ],
  },
];

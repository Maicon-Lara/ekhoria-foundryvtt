...
// `usos_dia` vira um número fixo por nível no sistema (daily_uses), e o OD2 não
// tem como derivar "igual ao seu modificador de Inteligência". Onde a regra
// amarra o uso a um modificador, o compêndio entrega o mínimo declarado (1) e
// diz onde o jogador corrige — mesmo desenho da nota de Talentos, que também
// depende de um atributo que a ficha calcula por conta própria.
...
export const classes = [
  ...
  },
  {
    ...
    habilidades: [
      ...
      { nome: "Consagrar os Esquecidos", level: 1, usos_dia: { 1: 1, 3: 2, 10: 3 }, desc: "<p>Brandindo seu símbolo sagrado, submete mortos-vivos a até 18 metros que falharem em Teste de Moral; eles obedecem a comandos simples por 1d6 rodadas. Controle Total: se o morto-vivo falhar com dados iguais (dois 4, dois 5 ou dois 6), permanece sob controle total até o próximo amanhecer. Uma vez por dia.</p>", level3: "<p>+1 no teste e duas vezes por dia.</p>", level10: "<p>+2 no teste e três vezes por dia.</p>" },
  ...
  },
  {
    ...
    habilidades: [
      ...
      { nome: "Imune à Corrupção", level: 6, usos_dia: 1, desc: "<p>Recebe +2 nas Jogadas de Proteção contra efeitos de Morte, drenagem, maldições e Medo. Uma vez por dia, dissipa um desses efeitos em si mesmo ou num aliado tocado, como <em>Dissipar Magia</em>.</p>" },
      { nome: "Veredicto Lunar", level: 10, usos_dia: 1, desc: "<p>Um número de vezes por dia igual ao modificador de Sabedoria (mínimo 1), aponta para um alvo a até 9 m, que faz JPC (Constituição) Difícil (−2). Falha: mortos-vivos são destruídos; caóticos ou necromantes sofrem 3d8 de dano mágico (neutros ou ordeiros, metade). Sucesso: metade do dano ou evita a destruição.</p>" + AJUSTE_USOS("Sabedoria") },
      { nome: "Reputação", level: 11, desc: "<p>Obtém Reputação 1 em 1d6, evoluindo +1 até o máximo de 1–5 em 1d6 no 15º nível.</p>" },
    ],
  },
  {
  ...
  },
  {
    ...
    levels: progressao("guerreiro_esp"),
    habilidades: [
      { nome: "Técnicas de Maestria", level: 1, desc: "<p>Escolhe <strong>duas</strong> propriedades de maestria entre as oito: <em>Corte Rápido, Irritar, Debilitar, Arranhão, Derrubar, Empurrar, Desacelerar</em> e <em>Trespassar</em>. Sempre que empunhar uma arma compatível, pode aplicar suas maestrias — <strong>apenas uma por ataque</strong>. Quando uma maestria exigir Ajuste, valem as regras normais de <strong>Ajuste Fácil (+2)</strong> e <strong>Ajuste Difícil (−2)</strong>.</p><p><strong>Limite de encadeamento:</strong> ataques bônus concedidos por uma maestria (como <em>Corte Rápido</em> ou <em>Trespassar</em>) não desencadeiam novas maestrias de ataque extra, e o Mestre das Armas realiza <strong>no máximo um ataque bônus de maestria por rodada</strong>.</p><p><em>Na ficha:</em> as oito maestrias estão no compêndio de Classes, em <strong>Mestre das Armas › Maestrias</strong> — arraste para dentro do item da classe apenas as que você domina. São duas no 1º nível, quatro no 3º, seis no 6º e todas as oito no 10º.</p>" },

...
export const classes = [
  {
    ...
    habilidades: [
      ...
      { nome: "Núcleo da Chama Primordial", level: 1, desc: "<p>Canaliza energia sagrada através da Pedra da Alma, preparando e lançando Magias Divinas desde o 1º nível (sem bônus de slots por Sabedoria). Recebe uma <strong>terceira</strong> característica de Construção Variável no 1º nível (totalizando 3 com as 2 da raça Autokthon).</p><p><em>Na ficha:</em> além das 2 escolhas da raça, adicione a habilidade de raça <strong>Construção Variável (Custódio Solar)</strong> — disponível no compêndio <em>Ekhoria: Raças</em>, pasta \"Aprimoramentos de Classe\" — para liberar o 3º seletor de construção.</p>" },
  ...
  },
  {
    ...
    habilidades: [
      ...
      { nome: "Talentos de Caçador", level: 1, desc: "<p>Começa com 2 pontos em cada um dos cinco talentos e 2 pontos adicionais para distribuir; máximo de 5 por talento. <strong>Bônus de Destreza:</strong> recebe, no 1º nível, 1 ponto extra por ponto de modificador de Destreza.</p>", level3: "<p>Recebe 2 pontos para evoluir seus talentos.</p>", level6: "<p>Recebe 2 pontos para evoluir seus talentos.</p>", level10: "<p>Recebe 2 pontos para evoluir seus talentos.</p>", rogue_talents: [
        { key: "armadilha", name: "Armadilha", description: "Detectar, desarmar ou montar armadilhas." },
        { key: "rastrear", name: "Rastrear", description: "Identificar e seguir rastros, inclusive térmicos ou no vazio." },

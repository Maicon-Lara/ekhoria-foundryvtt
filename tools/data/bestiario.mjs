  ...
  // Nenhum deles declara tamanho na fonte — campo omitido de propósito.
  {
    ...
    monstros: [
      ...
      },
      {
        ...
        tipo: "Arkanim — Mago (Arcanista da Ars Vocalis) 4º",
        conceito: "Humanoide",
        alinhamento: "neutro",
        movimento: "9 m",
        dv: "4",
      ...
      },
      {
        ...
        tipo: "Meio-elfo — Ladrão (Corvo) 5º",
        conceito: "Humanoide",
        alinhamento: "neutro",
        movimento: "9 m",
        dv: "5",

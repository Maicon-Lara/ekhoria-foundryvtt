// Geração de Actors de monstro do OD2 para "Ekhoria".
//
// ─────────────────────────────────────────────────────────────────────────────
...
export function monsterDoc(monstro, folderId, seedPrefix, sort) {
  ...
  // derivar do DV só vale como último recurso, e erra feio em chefes
  // (ex.: Rorik tem 83 PV na ficha, mas o DV derivaria 40).
